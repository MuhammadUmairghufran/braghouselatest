            ...
            <Animated.View style={{opacity: this.headerBg, zIndex: 1}}>
              ...
              <LinearGradient
                    ...
                    <View style={{alignItems: 'center', paddingTop: 20, paddingBottom: 20}}>
                      ...
                      <H3 style={{marginTop: 14, fontSize: 22, color:'#FFFFFF'}}>Alabama Crimson Tide</H3>
              ...
              <Footer>
                <FooterTab style={{backgroundColor: 'transparent'}}>
                  <Button vertical active>
                    <Icon name="home" />
                    <Text style={{color:'rgba(255,255,255,1)', marginTop: 3, fontSize: 11}}>Home</Text>
                  </Button>
                  <Button vertical>
                    <Icon name="apps" />
                    <Text style={{color:'rgba(255,255,255,0.5)', marginTop: 3, fontSize: 11}}>Bragboard</Text>
                  </Button>
                  <Button vertical>
                    <Icon active name="notifications" />
                    <Text style={{color:'rgba(255,255,255,0.5)', marginTop: 3, fontSize: 11}}>Notifications</Text>
                  </Button>
                  <Button vertical>
                    <Icon name="person" />
                    <Text style={{color:'rgba(255,255,255,0.5)', marginTop: 3, fontSize: 11}}>My Profile</Text>
                  </Button>
                </FooterTab>
              </Footer>
            </LinearGradient>
