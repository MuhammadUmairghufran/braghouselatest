...
export default class ConferenceTeam extends Component {
  ...
  componentDidMount()
  {
    ...
    var conference = ConstantLib.DATA;
...
<View style={{ flex:12,justifyContent:'flex-start', alignItems: 'center', backgroundColor: 'transparent'}}>
          <Text   style={AppStyles.header_title}>{ConstantLib.DATA.conference_name}</Text>
