...
//var bragBoardList = ['a','b','c','a','b','c','a','b','c'];

  export default class MyBragBoardOverAll extends Component{
    constructor(props) {
        super(props);
        this.state = {
          isLoading:false,
  ...
  componentDidMount()
  {
    this.callBraggersApi();
        ...
        callBraggersApi() {
          ...
          WSManager.postData(URLConstants.GET_OVERALL_LEADERBOARD, params)
            .then(response => {
