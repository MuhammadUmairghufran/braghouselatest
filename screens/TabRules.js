...
export default class TabRules extends Component {
	constructor(props) {
	    super(props);
	    this.state = {
	    }
  ...
  render() {
    return (
      <View style={{padding: 15, paddingBottom: 0, flex:1, backgroundColor: '#fff'}}>
        <ScrollView showsVerticalScrollIndicator={false}>
        	<TouchableOpacity onPress={() => this.props.navigation.navigate('Lobbydetail')} activeOpacity={0.7} style={{backgroundColor: '#fff'}}>
				        	<Card style={{paddingVertical: 15, borderRadius: 5, marginBottom: 10, borderWidth: 0, borderTopWidth: 0, borderBottomWidth: 0, borderLeftWidth: 0, borderRightWidth: 0, shadowColor: '#000', elevation: 2, shadowOpacity: 0.2, shadowOffset: { width: 0, height: 2 }, shadowRadius: 10, backgroundColor: '#FFF'}}>
					            <CardItem>
					              <Body>
					                <Grid style={{justifyContent: 'center'}}>
					                	...
					                	<Col style={{alignItems:'center', justifyContent: 'center'}}>
					                		...
					                		<TouchableOpacity onPress={() => this.props.navigation.navigate('Lobbydetail')}  style={{borderWidth: 1, borderColor: '#E2E2E2', borderRadius: 11, paddingHorizontal: 8, paddingVertical: 4}}>
					                			<Text style={{color:'#666666', fontSize: 11, fontFamily:'SourceSansPro-Bold'}}>28 Brags</Text>
					                		</TouchableOpacity>
					                	</Col>
					                	<Col style={{ width: 70, alignItems: 'center', justifyContent: 'center'}}>
					                		<View>
